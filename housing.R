...
map_ts067_no_unpaid_care <- ggplot(sf_lsoa21 %>% inner_join(df_ts067_lsoa, by = c('LSOA21CD' = 'LSOA21CD', 'LSOA21NM' = 'LSOA21NM'))) %+%
...
ggsave('.\\outputs\\07_unpaid_care\\map_ts067_no_unpaid_care_dark.png', map_ts067_no_unpaid_care, height = 297, width = 210, units = 'mm')
map_ts067_no_unpaid_care <- map_ts067_no_unpaid_care %+% scale_fill_viridis_c(direction = -1, labels = percent_format(accuracy = 1))
ggsave('.\\outputs\\07_unpaid_care\\map_ts067_no_unpaid_care_light.png', map_ts067_no_unpaid_care, height = 297, width = 210, units = 'mm')
